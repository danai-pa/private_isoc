...
class ActiveDutyPersonnel(Base):
    __tablename__ = "active_duty_personnel"
    ...
    personnel_no_10 = Column(String(10))
    ...
    education_major = Column(String(255))
    ...
    contact_amphor = Column(String(100))
