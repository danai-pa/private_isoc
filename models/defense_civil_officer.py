...
class DefenseCivilOfficer(Base):
    __tablename__ = "defense_civil_officer"
    ...
    first_name_old = Column(String(100))
    last_name_old = Column(String(100))
    ...
    employee_id_10_digit = Column(String(10))
    ...
    reg_house_no = Column(String(50))
    reg_village_no = Column(String(10))
    reg_soi = Column(String(100))
    reg_road = Column(String(100))
    reg_province = Column(String(100))
    reg_district = Column(String(100))
    reg_subdistrict = Column(String(100))
    reg_postcode = Column(String(10))

    education_level = Column(String(255))
    major = Column(String(255))

    contact_house_no = Column(String(50))
    contact_village_no = Column(String(10))
    contact_soi = Column(String(100))
    contact_road = Column(String(100))
    contact_province = Column(String(100))
    contact_district = Column(String(100))
    contact_subdistrict = Column(String(100))
